...
export async function setupAuth(app: Express) {
  ...
  if (!domains.includes('swipeeclean.com')) {
    domains.push('swipeeclean.com');
  }
  
  console.log('Configured domains for auth:', domains);
  ...
  app.get("/api/callback", (req, res, next) => {
    console.log('Callback from hostname:', req.hostname);
    passport.authenticate(`replitauth:${req.hostname}`, {
